...
def main():
    try:
      ...
      shutil.copyfile("../../simple_project/markup/login.mu", markup+"/login.mu")
      shutil.copyfile("../../simple_project/brower/register.go", markup+"/register.go")
      shutil.copyfile("../../simple_project/app/darth.go", markup+"/darth.go")
