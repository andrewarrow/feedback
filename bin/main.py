...
def main():
    try:
      ...
      shutil.copyfile("../../simple_project/markup/register.mu", markup+"/register.mu")
      shutil.copyfile("../../simple_project/markup/login.mu", markup+"/../app/login.mu")
      shutil.copyfile("../../simple_project/brower/register.go", markup+"/../app/register.go")
      shutil.copyfile("../../simple_project/app/darth.go", markup+"/../app/darth.go")
